...
2. You will be required to add a git remote repository to your current project
    * You can check out [this video](https://www.youtube.com/watch?v=oigQwU7o-as), which walks you through the process of adding a remote git repository to your Project in Visual Studio Code and syncronize it.  

3. Login to your GitHub account. Yoou should see all your project files in your Repository  
...
* This is a very common problem. Make sure that the source branch for GitHub pages (As shown in Step 8 part 2) and your updated branch is the same.
